...
def get_user_by_google_id(tx: ManagedTransaction, google_id: str) -> Optional[schemas.UserInDB]:
...
def create_user_from_google(tx: ManagedTransaction, user_in: schemas.UserCreateGoogle) -> schemas.UserInDB:
...
def link_google_id_to_user(tx: ManagedTransaction, user_id: str, google_id: str) -> bool:
